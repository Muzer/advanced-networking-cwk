...
thread.start_new_thread(WiFi.comms.timeOuter, (nameTimeMapWiFi, username,myIP,bcIP,))
thread.start_new_thread(zigbee.comms.timeOuter, (zbee, nameTimeMapZigbee, username,myAddr,bcAddr))
